...
Builds Bh. Called during the member list initialization of the constructor of this class. \[ \mathbf{B_h} = \left[ \begin{array}{c} \delta^3/6 \\ \delta t^2/2 \\ \delta t \end{array} \right] \]
