...
// namespace sequence{
    void LeftRightHandReach::doInit(ocra::Controller& ctrl, ocra::Model& model)
    {
        ...
        taskManagers["tmFull"] = new ocra::FullPostureTaskManager(ctrl, model, "fullPostureTask", ocra::FullState::INTERNAL, 20.0, 3.0, 0.01, nominal_q);
        ...
        taskManagers["tmCoM"] = new ocra::CoMTaskManager(ctrl, model, "CoMTask", ocra::XYZ, 10.0, 3.0, 10.0, posCoM);
        ...
        taskManagers["tmSegCartHandRight"] = new ocra::SegCartesianTaskManager(ctrl, model, "rightHandCartesianTask", "r_hand", ocra::XYZ, 10.0, 3.0, 100.0, posRHandDes);
