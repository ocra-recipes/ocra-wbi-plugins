...
{\footnotesize\ttfamily Eigen\+::\+Vector\+Xd ocra\+::utils\+::adapt\+K\+To\+Inertia (\begin{DoxyParamCaption}\item[{const Eigen\+::\+Vector\+Xd \&}]{K,  }\item[{const \hyperlink{classocra_1_1Model}{Model} \&}]{model,  }\item[{double}]{scale = {\ttfamily 1.} }\end{DoxyParamCaption})}
