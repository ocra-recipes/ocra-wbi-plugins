...
int main(int argc, char** argv)
{
    ...
    cout<<"CREATE TASKS\n";
//================ FULL STATE ==============================================================================//
    Eigen::VectorXd posDes = Eigen::VectorXd::Constant(model.nbInternalDofs(), 0.0);
    Eigen::Displacementd posLhandDes = Eigen::Displacementd(-0.3,-0.3,0.2);
    iCubPostureTaskGenerator tgPosture(tManager,"postureTask",orc::FullState::INTERNAL, posDes, 4.0, 4.0, 0.01);
    iCubCartesianTaskGenerator tgLhand(tManager,"lhandTask", "l_hand",orc::XYZ, posLhandDes, 20.0, 8.0, 100.0);
