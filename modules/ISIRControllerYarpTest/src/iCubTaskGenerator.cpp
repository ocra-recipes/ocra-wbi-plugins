...
iCubCartesianTaskGenerator::iCubCartesianTaskGenerator(iCubTaskManager& tManager,const std::string& taskName,const std::string& segmentName,orc::ECartesianDof axes, Eigen::Displacementd target, double stiffness, double damping, double weight)
...
iCubPostureTaskGenerator::iCubPostureTaskGenerator(iCubTaskManager& tManager,const std::string& taskName,int state, Eigen::VectorXd& target, double stiffness, double damping, double weight)
    :model(tManager.getModel())
    ,taskManager(tManager)
{
