...
#ifndef _ICUBMODEL_H_
#define _ICUBMODEL_H_

#include "orc/control/Model.h"


class iCubModel: public orc::Model
{
public:

//===========================Constructor/Destructor===========================//
    iCubModel(const std::string& robotName);
    virtual ~iCubModel();
...
private:
    struct Pimpl;
    boost::shared_ptr<Pimpl> pimpl; // where all internal data are saved
...
extern "C"
{
    ...
    {
        return new iCubModel(robotName);
    }
}
