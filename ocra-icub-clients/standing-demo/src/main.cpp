 ...
 */
/*
 *  This file is part of standing-demo.
...
int main (int argc, char * argv[])
{
    ...
    ctrlClient = std::make_shared<StandingDemoClient>(modelIni.getModel(), loopPeriod);
    ...
    rf.setVerbose(true);
    rf.setDefaultConfigFile("standing-demo.ini"); //default config file name.
    rf.setDefaultContext("standing-demo"); //when no parameters are given to the module this is the default context
